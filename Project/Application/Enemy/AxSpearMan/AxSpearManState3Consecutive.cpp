...
void AxSpearManState3Consecutive::Attack()
{
	...
	// コライダー更新
	bool isAttack = (inPhase_ == static_cast<uint32_t>(ComboPhase::kkAttack1)) || 
			(inPhase_ == static_cast<uint32_t>(ComboPhase::kkAttack2)) ||
			(inPhase_ == static_cast<uint32_t>(ComboPhase::kkAttack3));
